...
StudentAddressSchema.methods.isValidPassword = async function(res,password) {
    try {
...
module.exports= { StudentAddress : db.model('studentAddress', StudentAddressSchema), ObjectId };
